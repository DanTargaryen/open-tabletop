...
test('collection serves catalog, both game entries and assets without exposing source or runtime files',async t=>{
 ...
 const {data:catalog}=await call(app,'/games.json');assert.deepEqual(catalog.map(game=>game.id),['texas-holdem','splendor','abracada-what']);
 for(const path of [...catalog.flatMap(game=>[game.solo,game.online]),'/vendor/three.module.js','/vendor/three.core.js','/vendor/loaders/GLTFLoader.js','/vendor/utils/BufferGeometryUtils.js','/vendor/utils/SkeletonUtils.js','/games/texas-holdem/online-ui.js','/games/texas-holdem/room-sync.js','/games/texas-holdem/style.css','/games/texas-holdem/assets/brands/doubao.png','/games/abracada-what/engine.js','/games/abracada-what/ui.js','/games/abracada-what/online-ui.js','/games/abracada-what/three-table.js','/games/abracada-what/tower-progress.js','/games/abracada-what/online.css','/games/abracada-what/style.css','/games/abracada-what/assets/3d/characters/mage.glb','/games/abracada-what/assets/3d/animations/general.glb','/games/abracada-what/assets/3d/dungeon/wall_shelves.gltf','/games/abracada-what/assets/3d/dungeon/wall_shelves.bin','/games/abracada-what/assets/3d/particles/spark_01.png',...Array.from({length:8},(_,index)=>`/games/abracada-what/assets/spells/spell-${index+1}.svg`),'/app.js','/style.css','/favicon.svg'])assert.equal((await fetch(app.url+path)).status,200,path);
