...
test('collection serves catalog, both game entries and assets without exposing source or runtime files',async t=>{
 ...
 for(const path of [...catalog.flatMap(game=>[game.solo,game.online]),'/games/texas-holdem/online-ui.js','/games/texas-holdem/room-sync.js','/games/texas-holdem/style.css','/games/texas-holdem/assets/brands/doubao.png','/games/abracada-what/engine.js','/games/abracada-what/ui.js','/games/abracada-what/online-ui.js','/games/abracada-what/tower-progress.js','/games/abracada-what/online.css','/games/abracada-what/style.css',...Array.from({length:8},(_,index)=>`/games/abracada-what/assets/spells/spell-${index+1}.svg`),'/app.js','/style.css','/favicon.svg'])assert.equal((await fetch(app.url+path)).status,200,path);
