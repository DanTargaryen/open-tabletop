...
test('all five Node API adapters preserve rate-limit errors after integration', async t => {
  ...
  for (const game of ['poker', 'splendor', 'abracada', 'aeroplane', 'buckshot']) {
...
test('configured Cloudflare migrations support independent rooms for all five games', async t => {
