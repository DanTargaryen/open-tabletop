...
test('all seven Node API adapters preserve rate-limit errors after integration', async t => {
  ...
  for (const game of ['poker', 'splendor', 'abracada', 'aeroplane', 'buckshot', 'steel-arc', 'anime-campus']) {
...
test('configured Cloudflare migrations support independent rooms for all seven games', async t => {
